...
fn throttle_to_full_airspeed() {
    let model = FlightModel { mass_kg: 500.0, wing_area_m2: 10.0, cd0: 0.04, k: 0.04, thrust_n: 20000.0 };
...
fn zero_throttle_decelerates() {
    let model = FlightModel { mass_kg: 1000.0, wing_area_m2: 10.0, cd0: 0.04, k: 0.04, thrust_n: 0.0 };
